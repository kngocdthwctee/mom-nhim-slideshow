...
BaseSlide.CHARACTERS = [
    {
        ...
        avatar: 1,
        treeOwner: "caymit",
        giftMessages: ["Mít chín rồi nè! 🍈", "Thơm quá đi! 😋", "Mời mọi người ăn mít!"],
        noGiftMessages: ["Chưa chín đâu...", "Đang ra hoa thôi 🌸", "Đợi thêm chút nữa nha"]
    },
    {
        id: 2,
        name: "qn",
        messages: ["mom trap qn"],
        avatar: 2,
        treeOwner: "cayxoai",
    ...
    { id: 5, name: "Hluan", messages: ["chị Nhím địch"], avatar: 5 },
    { id: 6, name: "tvy", messages: ["chị nhímmmm"], avatar: 6 },
    { id: 7, name: "ThTien", messages: ["bà dà Nhím"], avatar: 7 },
    { id: 8, name: "tngyn", messages: ["2 ko tin em hả"], avatar: 8 },
    { id: 9, name: "anhPhong", messages: ["Nhím chua"], avatar: 9 },
    { id: 10, name: "nno", messages: ["155..."], avatar: 10 },
    { id: 11, name: "XThanh", messages: ["ăn uống gì chưa z"], avatar: 11 },
    { id: 12, name: "Bé5", messages: ["mom ơiii"], avatar: 12 },
    { id: 13, name: "Dòi", messages: ["đún đún"], avatar: 13 },
    { id: 14, name: "Táo", messages: ["trào mum"], avatar: 14 },
    { id: 15, name: "Zin", messages: ["rep chuỗiii"], avatar: 15 },
    { id: 16, name: "Bon", messages: ["chị nhiễm"], avatar: 16 },
    { id: 17, name: "Ếch", messages: ["nay hiền ko khịa Nhím nữa"], avatar: 17 },
    { id: 18, name: "Xuyến", messages: ["đi chơi điii"], avatar: 18 },
    { id: 19, name: "Giang", messages: ["0 có"], avatar: 19 },
    { id: 20, name: "Nom", messages: ["ê m ơi, có biến"], avatar: 20 },
    { id: 21, name: "NHND", messages: ["ngủ sớm chưa???"], avatar: 21 },
    { id: 22, name: "Anh3", messages: ["em t tẽn lắm chứ khong thể dth v được"], avatar: 22 },
    { id: 23, name: "TuJuno", messages: ["cục Thuy ơi"], avatar: 23 },
    { id: 24, name: "TuấnL", messages: ["BFF ^.^"], avatar: 24 },
    { id: 25, name: "Tuấncon", messages: ["2 đợi em đi nvqs về nha"], avatar: 25 },
    { id: 26, name: "Latuna", messages: ["10k mute mom"], avatar: 26 },
    { id: 27, name: "ChịBi", messages: ["chào em gái của chị"], avatar: 27 },
    { id: 28, name: "Chanh", messages: ["chị iuuu"], avatar: 28 },
    { id: 29, name: "TP", messages: ["4-0"], avatar: 29 },
    { id: 30, name: "Kenny", messages: ["lâu quá ko gặp"], avatar: 30 },
    { id: 31, name: "Lê Bảo", messages: ["thả nhãn dán hết live ..."], avatar: 31 },
    { id: 32, name: "VHieu", messages: ["ôi Thuy ơi"], avatar: 32 },
    { id: 33, name: "empuu", messages: ["em buòn quá Nhím ơi"], avatar: 33 },
    { id: 34, name: "cớt🐷", messages: ["li dị đi"], avatar: 34 },
    { id: 35, name: "LPhi", messages: ["cô ơiiiiii hóng hóng"], avatar: 35 },
    { id: 36, name: "Tiên Nữ", messages: ["cưng Nhím lắmmmm"], avatar: 36 },
    { id: 37, name: "qnhu", messages: ["bệnh bệnh kiểu gì á tr"], avatar: 37 },
    { id: 38, name: "anhCá", messages: ["anh có bắt chước đâu?"], avatar: 38 },
    { id: 39, name: "ThiSon", messages: ["hi chị Thuy"], avatar: 39 },
    { id: 40, name: "L.ANH", messages: ["hi bà"], avatar: 40 },
    { id: 41, name: "PNhi", messages: ["anh iu, lên SG lẹ đi em chờ"], avatar: 41 },
    { id: 42, name: "Chip", messages: ["mom ác nào giờ mà"], avatar: 42 },
    { id: 43, name: "pphhuy", messages: ["boy si tình"], avatar: 43 },
    { id: 44, name: "duke", messages: ["thầy ơi"], avatar: 44 },
    { id: 45, name: "Mò", messages: ["xin 500"], avatar: 45 },
    { id: 46, name: "Khánh", messages: ["hi Nhím"], avatar: 46 },
    { id: 47, name: "Leobae", messages: ["Nhím ơiiii ngta ăn hiếp chị"], avatar: 47 },
    { id: 48, name: "Xương", messages: ["chị đẹp tư vấn cho em"], avatar: 48 },
    { id: 49, name: "ChíVỹ", messages: ["2 có pro khong"], avatar: 49 },
    { id: 50, name: "HVĩ", messages: ["hehe"], avatar: 50 },
    { id: 51, name: "ChúcHà", messages: ["bà già"], avatar: 51 },
    ...
    { id: 57, name: "Triều", messages: ["đi đám cưới em !!!"], avatar: 57 },
    { id: 58, name: "btdung", messages: ["Nhím tệ"], avatar: 58 },
    { id: 59, name: "Cam", messages: ["Nhím cân4 đi, em cho kèo"], avatar: 59 },
    { id: 60, name: "TA", messages: ["ai hi chị đâu mà hi lại"], avatar: 60 },
    { id: 61, name: "emMy", messages: ["em bị vợ cho ra đường ngủ rồi anh ơi ..."], avatar: 61 },
    { id: 62, name: "TấnDũng", messages: ["trà sữa hong mom"], avatar: 62 },
    { id: 63, name: "NhânPhan", messages: ["Hi Nhím"], avatar: 63 },
    ...
    { id: 68, name: "lhuong", messages: ["ủa nhím?"], avatar: 68 },
    { id: 69, name: "Nhoxing", messages: ["sao chị làm z với emmm"], avatar: 69 },
    { id: 70, name: "Chii", messages: ["💗"], avatar: 70 },
    { id: 71, name: "xh", messages: ["tui rank ht mà"], avatar: 71 },
    { id: 72, name: "Salm", messages: ["đuổi hong đi"], avatar: 72 },
    { id: 73, name: "HHung", messages: ["bấm lộn"], avatar: 73 },
    { id: 74, name: "TrieuNam", messages: ["chặn rồi, khỏi kiếm"], avatar: 74 },
    { id: 75, name: "Gnasche", messages: ["âm thầm điểm danh"], avatar: 75 },
    { id: 76, name: "chịTom", messages: ["quen biết gì mà hello"], avatar: 76 },
    { id: 77, name: "Ghost", messages: ["hi mom"], avatar: 77 },
    { id: 78, name: "Chuột", messages: ["hi 2, Chuột mới làm về"], avatar: 78 },
    { id: 79, name: "Tbien", messages: ["lâu quá hong gặp cô"], avatar: 79 },
    { id: 80, name: "Louis", messages: ["Nhím vẫn ế hả?"], avatar: 80 },
    { id: 81, name: "Paw", messages: ["coi chùa"], avatar: 81 },
    { id: 82, name: "Đạica", messages: ["Chào mày"], avatar: 82 },
    { id: 83, name: "Star", messages: ["hẹn gặp lại mùa hoa nở"], avatar: 83 },
