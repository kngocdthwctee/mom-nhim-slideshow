...
BaseSlide.CHARACTERS = [
    ...
    { id: 25, name: "Tuấncon", messages: ["2 đợi em đi nvqs về nha"], avatar: 46 },
    { id: 26, name: "Latuna", messages: ["10k mute mom"], avatar: 26 },
    { id: 27, name: "ChịBi", messages: ["chào em gái của chị"], avatar: 39 },
    ...
    { id: 32, name: "VHieu", messages: ["ôi Thuy ơi"], avatar: 10 },
